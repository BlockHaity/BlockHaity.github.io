...
![Deepin所在内核树的关系](/img/如何安装Deepin/ppHVZJx.png)
...
![msinfo32界面](/img/如何安装Deepin/ppHBMwQ.png)
...
![所需设备和软件](/img/如何安装Deepin/p9SdTN6.png)
...
![Ventoy界面](/img/如何安装Deepin/ppHBeQf.png)
...
![DiskGenius界面](/img/如何安装Deepin/p9p7z7R.png)

选择你的C盘或D盘，点击调整分区容量。如下图这样配置。后部容量在40~20GB即可，点击确定

![调整分区容量](/img/如何安装Deepin/p9pHNEn.png)

点击确认，再点击灰色区域，点击建立新分区，如下图这样配置。点击确定

![建立分区](/img/如何安装Deepin/p9pquSf.png)
...
![安装界面](/img/如何安装Deepin/p991nZ8.png)

出现如下图所示的界面，点击手动安装。

![安装界面1](/img/如何安装Deepin/p991udS.png)

如下图所示，点击右侧为ext4的分区。

![安装界面2](/img/如何安装Deepin/p991KIg.png)

点击右侧的铅笔✏️图标，按下图所示配置。

![分区配置](/img/如何安装Deepin/p991udS.png)
